<div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header text-center">Crear Unidad medida</div>
      <div class="card-body">
        <form class="user" enctype="multipart/form-data" method="POST" action="<?php echo getUrl("Unidad_Medida", "UnidadMedida", "postCrear");?>">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  Codigo <input type="number" id="Codigo" class="form-control" placeholder="Codigo" readonly name="Codigo"  value="<?php echo $num_uni; ?>">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-label-group">
